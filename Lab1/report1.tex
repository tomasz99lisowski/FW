...
Ostateczne wyniki pomiarów gęstości cieczy wraz z niepwnościami pomiarowymi zależą od przyjęcia pewnych danych wzorcowych. Dla poniższych pomiarów przyjęto gęstość wody $\rho_w = 1000kg/m^3$
